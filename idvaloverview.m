function [modelVAF_val]=idvaloverview(FITje,FITje_val,dirdmd)
...
%sval=plot(x,yexp);
legend('VAF: Identification Models','VAF: Identification Models','VAF: Validation Models','VAF: Validation Models','Location','best');
